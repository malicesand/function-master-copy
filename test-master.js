(function(){
    ...
    QUnit.test("Functions can access/modify variables in parent scope.", function(assert){
      ...
      function yay(){
        // invoke yay function
        var inside_the_function = "can you see me?"; // function scoped variable
        outside_the_function = inside_the_function; // reassigns global scoped String to function scoped String above
      }
  
      yay();
      // function manipulates the variable outside_the_function 
      assert.equal(outside_the_function, "can you see me?")
    });

    /*
    * above tech example of COPY BY VALUE
    * 
    * outside_the_function
        |
        inside_the_function => 'can you see me'
    *  */
